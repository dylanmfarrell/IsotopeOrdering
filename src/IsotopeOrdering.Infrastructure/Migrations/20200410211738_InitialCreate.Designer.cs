...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200410211738_InitialCreate")]
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 4, 10, 16, 17, 38, 293, DateTimeKind.Local).AddTicks(632),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 4, 10, 16, 17, 38, 293, DateTimeKind.Local).AddTicks(632)
                        });
                });
