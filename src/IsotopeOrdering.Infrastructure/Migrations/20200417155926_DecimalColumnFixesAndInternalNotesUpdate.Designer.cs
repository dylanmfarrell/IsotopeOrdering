...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200417155926_DecimalColumnFixesAndInternalNotesUpdate")]
    partial class DecimalColumnFixesAndInternalNotesUpdate
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 4, 17, 10, 59, 26, 245, DateTimeKind.Local).AddTicks(2738),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 4, 17, 10, 59, 26, 245, DateTimeKind.Local).AddTicks(2738)
                        });
                });
