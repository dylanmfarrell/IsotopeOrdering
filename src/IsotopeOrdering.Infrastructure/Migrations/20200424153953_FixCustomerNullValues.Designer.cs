...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200424153953_FixCustomerNullValues")]
    partial class FixCustomerNullValues
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 4, 24, 10, 39, 53, 389, DateTimeKind.Local).AddTicks(4210),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 4, 24, 10, 39, 53, 389, DateTimeKind.Local).AddTicks(4210)
                        });
                });
