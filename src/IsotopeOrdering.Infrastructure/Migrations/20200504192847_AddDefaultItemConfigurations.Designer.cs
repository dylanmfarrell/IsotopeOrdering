...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200504192847_AddDefaultItemConfigurations")]
    partial class AddDefaultItemConfigurations
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 5, 4, 14, 28, 46, 912, DateTimeKind.Local).AddTicks(104),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 5, 4, 14, 28, 46, 912, DateTimeKind.Local).AddTicks(104)
                        });
                });
