...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200507200322_RemoveInstitutionFromOrder")]
    partial class RemoveInstitutionFromOrder
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 5, 7, 15, 3, 22, 9, DateTimeKind.Local).AddTicks(8094),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 5, 7, 15, 3, 22, 9, DateTimeKind.Local).AddTicks(8094)
                        });
                });
