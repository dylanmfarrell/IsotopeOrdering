...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200522161152_UpdateCustomerIdOnItemConfigurations")]
    partial class UpdateCustomerIdOnItemConfigurations
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 5, 22, 11, 11, 51, 930, DateTimeKind.Local).AddTicks(1555),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 5, 22, 11, 11, 51, 930, DateTimeKind.Local).AddTicks(1555)
                        });
                });
