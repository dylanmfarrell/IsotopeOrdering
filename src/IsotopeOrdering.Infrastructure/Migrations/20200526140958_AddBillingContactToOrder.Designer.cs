...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200526140958_AddBillingContactToOrder")]
    partial class AddBillingContactToOrder
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 5, 26, 9, 9, 57, 787, DateTimeKind.Local).AddTicks(7135),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 5, 26, 9, 9, 57, 787, DateTimeKind.Local).AddTicks(7135)
                        });
                });
