...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200526204056_AlterRequestDateNullable")]
    partial class AlterRequestDateNullable
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 5, 26, 15, 40, 56, 200, DateTimeKind.Local).AddTicks(224),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 5, 26, 15, 40, 56, 200, DateTimeKind.Local).AddTicks(224)
                        });
                });
