...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200624184856_UpdateFormTable")]
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 6, 24, 13, 48, 55, 477, DateTimeKind.Local).AddTicks(3266),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 6, 24, 13, 48, 55, 477, DateTimeKind.Local).AddTicks(3266)
                        });
                });
