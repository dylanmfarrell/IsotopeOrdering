...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200706172049_AddCountryToAddress")]
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 7, 6, 12, 20, 49, 245, DateTimeKind.Local).AddTicks(9697),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 7, 6, 12, 20, 49, 245, DateTimeKind.Local).AddTicks(9697)
                        });
                });
