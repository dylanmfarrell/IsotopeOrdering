...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200706173138_AddDefaultsAmountsToItem")]
    partial class AddDefaultsAmountsToItem
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 7, 6, 12, 31, 38, 235, DateTimeKind.Local).AddTicks(5437),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 7, 6, 12, 31, 38, 235, DateTimeKind.Local).AddTicks(5437)
                        });
                });
