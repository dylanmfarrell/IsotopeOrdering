...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200707153736_AdjustDecimalsForPriceAmounts")]
    partial class AdjustDecimalsForPriceAmounts
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 7, 7, 10, 37, 35, 634, DateTimeKind.Local).AddTicks(9943),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 7, 7, 10, 37, 35, 634, DateTimeKind.Local).AddTicks(9943)
                        });
                });
