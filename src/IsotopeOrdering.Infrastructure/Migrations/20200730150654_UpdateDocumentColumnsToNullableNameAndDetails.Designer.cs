...
namespace IsotopeOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20200730150654_UpdateDocumentColumnsToNullableNameAndDetails")]
    partial class UpdateDocumentColumnsToNullableNameAndDetails
    {
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Form", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "SYSTEM",
                            CreatedDate = new DateTime(2020, 7, 30, 10, 6, 53, 741, DateTimeKind.Local).AddTicks(9440),
                            IsDeleted = false,
                            Name = "Material Transfer Agreement",
                            Type = 0,
                            UpdatedBy = "SYSTEM",
                            UpdatedDate = new DateTime(2020, 7, 30, 10, 6, 53, 741, DateTimeKind.Local).AddTicks(9440)
                        });
                });
            ...
            modelBuilder.Entity("IsotopeOrdering.Domain.Entities.Item", b =>
                {
                    ...
                    b.Property<decimal?>("DefaultMaxQuantity")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("DefaultMinQuantity")
                        .HasColumnType("decimal(18,2)");
